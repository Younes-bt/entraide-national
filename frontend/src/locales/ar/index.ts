export const ar = {
  translation: {
    ...
    centerTrainersPage: {
      ...
      noTrainersMatchFilters: "لا يوجد مدربين يطابقون المرشحات الحالية.",
      noCenterAssigned: "لا يوجد مركز معين حاليًا.",
      noCenterDataTitle: "بيانات المركز غير متوفرة",
      noCenterDataDescription: "تعذر تحميل بيانات المركز. يرجى المحاولة مرة أخرى لاحقًا أو الاتصال بالدعم.",
      accessDenied: "الوصول مرفوض. هذه الصفحة مخصصة لمشرفي المراكز، أو أن معرّف المستخدم الخاص بك مفقود.",
      errorAuthNotAvailable: "المستخدم غير مصادق عليه أو الرمز المميز غير متوفر.",
    ...
    adminTrainersPage: {
      ...
      resultsCount: "عرض {{count}} من {{total}} مدربين",
      trainersListTitle: "قائمة المدربين",
      loadingMessage: "جارٍ تحميل المدربين...",
      errorFetching: "خطأ في جلب بيانات المدربين:",
      errorFetchingDetail: "فشل في جلب معلومات المدربين. يرجى المحاولة مرة أخرى.",
      noTrainersTitle: "لم يتم العثور على مدربين",
      noTrainersDescription: "لا يوجد حاليًا أي مدربين مسجلين في النظام.",
      noTrainersFound: "لم يتم العثور على مدربين.",
      noTrainersMatchFilter: "لا يوجد مدربين يطابقون المرشحات الحالية.",
      noTrainersMatchFilters: "لا يوجد مدربين يطابقون المرشحات الحالية.",
      noCenterAssigned: "لا يوجد مركز معين حاليًا.",
      noCenterDataTitle: "البيانات غير متوفرة",
      noCenterDataDescription: "تعذر تحميل البيانات. يرجى المحاولة مرة أخرى لاحقًا.",
      accessDenied: "الوصول مرفوض. هذه الصفحة مخصصة للمسؤولين.",
      errorAuthNotAvailable: "المستخدم غير مصادق عليه أو الرمز المميز غير متوفر.",
      noSpecialization: "لا يوجد تخصص",
      openMenu: "فتح القائمة",
      statusActive: "نشط",
      ...
      actions: {
        ...
        edit: "تعديل",
        delete: "حذف",
        confirmDelete: "هل أنت متأكد أنك تريد حذف هذا المدرب؟"
      },
      dialogDescription: "معلومات مفصلة عن المدرب.",
      dialogSections: {
        trainerInfo: "معلومات المدرب",
