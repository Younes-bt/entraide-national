"""
Django settings for entraide_backend project.
...
MIDDLEWARE = [
    ...
    'django.middleware.common.CommonMiddleware',  # added for CORS headers
    'django.middleware.locale.LocaleMiddleware',  # added for locale support

]

ROOT_URLCONF = 'entraide_backend.urls'
...
WSGI_APPLICATION = 'entraide_backend.wsgi.application'
...
# Add this after STATIC_URL definition
CLOUDINARY_STORAGE = {
